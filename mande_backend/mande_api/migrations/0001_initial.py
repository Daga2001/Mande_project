# Generated by Django 4.1.3 on 2023-02-01 00:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='location_id',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='location_id_user', to='mande_api.gps_location'),
        ),
        migrations.AddField(
            model_name='user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idc_img_data', models.ImageField(unique=True, upload_to='imagenesCedula/')),
                ('prof_img_data', models.ImageField(unique=True, upload_to='imagenesPerfil/')),
